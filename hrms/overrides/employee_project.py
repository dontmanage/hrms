...
from dontmanageerp.projects.doctype.project.project import Project
...
class EmployeeProject(Project):
	...
	def update_costing(self):
		...
		TimesheetDetail = dontmanage.qb.DocType("Timesheet Detail")
		from_time_sheet = (
			dontmanage.qb.from_(TimesheetDetail)
			.select(
