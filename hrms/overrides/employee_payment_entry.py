...
from dontmanageerp.accounts.doctype.payment_entry.payment_entry import (
	PaymentEntry,
...
def get_payment_entry_for_employee(dt, dn, party_amount=None, bank_account=None, bank_amount=None):
	...
	pe = dontmanage.new_doc("Payment Entry")
...
def get_reference_details_for_employee(reference_doctype, reference_name, party_account_currency):
	...
	company_currency = ref_doc.get("company_currency") or dontmanageerp.get_company_currency(
		ref_doc.company
	)
