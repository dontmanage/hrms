...
def create_employee_grievance():
	...
	grievance = dontmanage.new_doc("Employee Grievance")
...
def create_grievance_type():
	if dontmanage.db.exists("Grievance Type", "Employee Abuse"):
		return dontmanage.get_doc("Grievance Type", "Employee Abuse")
	grievance_type = dontmanage.new_doc("Grievance Type")
