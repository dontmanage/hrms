...
dontmanage.ui.form.on("Job Applicant", {
		...
		if (!frm.doc.__islocal) {
			if (frm.doc.__onload && frm.doc.__onload.job_offer) {
				...
				frm.add_custom_button(__("Job Offer"), function() {
					dontmanage.set_route("Form", "Job Offer", frm.doc.__onload.job_offer);
				}, __("View"));
			} else {
			...
			callback: function(r) {
				if (r.message) {
					...
					frm.dashboard.add_section(
						dontmanage.render_template("job_applicant_dashboard", {
