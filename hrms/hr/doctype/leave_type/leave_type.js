dontmanage.ui.form.on("Leave Type", {
	refresh: function(frm) {
	}
});


dontmanage.tour["Leave Type"] = [
	{
	...
	},
	{
		...
		description: __("Leaves you can avail against a holiday you worked on. You can claim Compensatory Off Leave using Compensatory Leave request. Click") + " <a href='https://docs.dontmanageerp.com/docs/v13/user/manual/en/human-resources/compensatory-leave-request' target='_blank'>here</a> " + __('to know more')
	},
	{
