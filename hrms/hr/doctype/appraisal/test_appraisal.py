...
class TestAppraisal(DontManageTestCase):
	def setUp(self):
		dontmanage.db.delete("Goal")
		dontmanage.db.delete("Appraisal")
		dontmanage.db.delete("Employee Performance Feedback")
	...
	def test_cycle_completion(self):
		...
		self.assertRaises(dontmanage.ValidationError, cycle.complete_cycle)
		...
		self.assertRaises(dontmanage.ValidationError, appraisal.insert)
