...
from dontmanage.utils import cint, get_datetime, get_link_to_form
...
class EmployeeCheckin(Document):
	...
	def validate_duplicate_log(self):
		...
		if doc:
			doc_link = dontmanage.get_desk_link("Employee Checkin", doc)
			dontmanage.throw(
...
def add_log_based_on_employee_field(
	...
	if not employee_field_value or not timestamp:
		dontmanage.throw(_("'employee_field_value' and 'timestamp' are required."))

	employee = dontmanage.db.get_values(
		"Employee",
	...
	doc = dontmanage.new_doc("Employee Checkin")
...
def mark_attendance_and_link_log(
	...
	if attendance_status == "Skip":
		...
		dontmanage.throw(_("{} is an invalid Attendance Status.").format(attendance_status))
