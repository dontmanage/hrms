...
dontmanage.ui.form.on('Training Event', {
	...
	refresh: function (frm) {
		if (!frm.doc.__islocal) {
			frm.add_custom_button(__("Training Result"), function () {
				...
				dontmanage.set_route("List", "Training Result");
			});
			frm.add_custom_button(__("Training Feedback"), function () {
				dontmanage.route_options = {
					training_event: frm.doc.name
				};
				dontmanage.set_route("List", "Training Feedback");
			});
		}
...
dontmanage.ui.form.on("Training Event Employee", {
