...
test_records = dontmanage.get_test_records("Attendance")


class TestAttendance(DontManageTestCase):
	def setUp(self):
	...
	def test_mark_absent(self):
		...
		fetch_attendance = dontmanage.get_value(
	...
	def test_unmarked_days(self):
		...
		dontmanage.db.set_value("Employee", employee, "holiday_list", self.holiday_list)
