...
from dontmanage.utils import get_year_ending, get_year_start, getdate
...
class TestMonthlyAttendanceSheet(DontManageTestCase):
	def setUp(self):
	...
	def test_attendance_with_group_by_filter(self):
		...
		department = dontmanage.db.get_value("Employee", self.employee, "department")
	...
	def test_validations(self):
		...
		self.assertRaises(dontmanage.ValidationError, execute_report_with_invalid_filters)
...
def execute_report_with_invalid_filters():
	filters = dontmanage._dict({"company": "_Test Company", "group_by": "Department"})
