...
import dontmanage
from dontmanage.utils import add_days, flt, get_year_ending, get_year_start, getdate
...
class TestEmployeeLeaveBalance(unittest.TestCase):
	...
	def test_employee_leave_balance_summary(self):
		dontmanage.get_doc(test_records[0]).insert()
		...
		expected_data = [
			[
				...
				dontmanage.db.get_value("Employee", self.employee_id, "department"),
				flt(
	...
	def test_employee_status_filter(self):
		...
		dontmanage.db.set_value("Employee", inactive_emp, "status", "Inactive")
