...
class TestEmployeeExits(unittest.TestCase):
	...
	def setUpClass(cls):
		create_company()
		dontmanage.db.sql("delete from `tabEmployee` where company='Test Company'")
		dontmanage.db.sql("delete from `tabFull and Final Statement` where company='Test Company'")
		dontmanage.db.sql("delete from `tabExit Interview` where company='Test Company'")
	...
	def test_employee_exits_summary(self):
		...
		employee1 = dontmanage.get_doc("Employee", self.emp1)
		employee2 = dontmanage.get_doc("Employee", self.emp2)
		expected_data = [
			{
	...
	def test_pending_exit_interviews_summary(self):
		...
		employee4 = dontmanage.get_doc("Employee", self.emp4)
		expected_data = [
			{
	...
	def test_pending_fnf_summary(self):
		...
		employee3 = dontmanage.get_doc("Employee", self.emp3)
		employee4 = dontmanage.get_doc("Employee", self.emp4)
		expected_data = [
			{
