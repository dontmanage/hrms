...
class TestAppraisalOverview(DontManageTestCase):
	def setUp(self):
	...
	def test_appraisal_overview(self):
		...
		appraisal = dontmanage.get_doc("Appraisal", {"employee": self.employee1})
		appraisal = dontmanage.get_doc("Appraisal", appraisal.name)
