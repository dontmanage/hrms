import dontmanage
from dontmanage.utils import add_months, get_first_day, get_last_day, getdate
...
def get_first_sunday(holiday_list="Salary Slip Test Holiday List", for_date=None):
	...
	first_sunday = dontmanage.db.sql(
		"""
...
def create_company(name=None):
	...
	if dontmanage.db.exists("Company", company_name):
		return dontmanage.get_doc("Company", company_name)
