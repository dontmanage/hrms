...
from hrms.subscription_utils import update_dontmanageerp_access
...
def get_custom_fields():
	"""HR specific custom fields that need to be added to the masters in DontManageErp"""
	return {
		"Employee": [
			{
...
def setup_notifications():
	base_path = dontmanage.get_app_path("hrms", "hr", "doctype")
...
def update_hr_defaults():
	hr_settings = dontmanage.get_doc("HR Settings")
...
def add_non_standard_user_types():
	...
	for user_type, data in user_types.items():
		user_type_limit.setdefault(dontmanage.scrub(user_type), 20)
...
def create_custom_role(data):
	if data.get("role") and not dontmanage.db.exists("Role", data.get("role")):
		dontmanage.get_doc(
...
def create_user_type(user_type, data):
	if dontmanage.db.exists("User Type", user_type):
		doc = dontmanage.get_cached_doc("User Type", user_type)
		doc.user_doctypes = []
	else:
		doc = dontmanage.new_doc("User Type")
		doc.update(
			{
				"name": user_type,
				"role": data.get("role"),
...
def update_select_perm_after_install():
	if not dontmanage.flags.update_select_perm_after_migrate:
		return

	dontmanage.flags.ignore_select_perm = False
	for row in dontmanage.get_all("User Type", filters={"is_standard": 0}):
		print("Updating user type :- ", row.name)
		doc = dontmanage.get_doc("User Type", row.name)
		doc.flags.ignore_links = True
		doc.save()

	dontmanage.flags.update_select_perm_after_migrate = False
...
def get_post_install_patches():
	return (
		"dontmanageerp.patches.v10_0.rename_offer_letter_to_job_offer",
		"dontmanageerp.patches.v10_0.migrate_daily_work_summary_settings_to_daily_work_summary_group",
		"dontmanageerp.patches.v11_0.move_leave_approvers_from_employee",
		"dontmanageerp.patches.v11_0.rename_field_max_days_allowed",
		"dontmanageerp.patches.v11_0.set_department_for_doctypes",
		"dontmanageerp.patches.v11_0.add_expense_claim_default_account",
		"dontmanageerp.patches.v11_0.drop_column_max_days_allowed",
		"dontmanageerp.patches.v11_0.rename_additional_salary_component_additional_salary",
		"dontmanageerp.patches.v11_1.set_salary_details_submittable",
		"dontmanageerp.patches.v11_1.rename_depends_on_lwp",
		"dontmanageerp.patches.v12_0.generate_leave_ledger_entries",
		"dontmanageerp.patches.v12_0.remove_denied_leaves_from_leave_ledger",
		"dontmanageerp.patches.v12_0.set_employee_preferred_emails",
		"dontmanageerp.patches.v12_0.set_job_offer_applicant_email",
		"dontmanageerp.patches.v13_0.move_tax_slabs_from_payroll_period_to_income_tax_slab",
		"dontmanageerp.patches.v12_0.remove_duplicate_leave_ledger_entries",
		"dontmanageerp.patches.v12_0.move_due_advance_amount_to_pending_amount",
		"dontmanageerp.patches.v13_0.move_doctype_reports_and_notification_from_hr_to_payroll",
		"dontmanageerp.patches.v13_0.move_payroll_setting_separately_from_hr_settings",
		"dontmanageerp.patches.v13_0.update_start_end_date_for_old_shift_assignment",
		"dontmanageerp.patches.v13_0.updates_for_multi_currency_payroll",
		"dontmanageerp.patches.v13_0.update_reason_for_resignation_in_employee",
		"dontmanageerp.patches.v13_0.set_company_in_leave_ledger_entry",
		"dontmanageerp.patches.v13_0.rename_stop_to_send_birthday_reminders",
		"dontmanageerp.patches.v13_0.set_training_event_attendance",
		"dontmanageerp.patches.v14_0.set_payroll_cost_centers",
		"dontmanageerp.patches.v13_0.update_employee_advance_status",
		"dontmanageerp.patches.v13_0.update_expense_claim_status_for_paid_advances",
		"dontmanageerp.patches.v14_0.delete_employee_transfer_property_doctype",
		"dontmanageerp.patches.v13_0.set_payroll_entry_status",
		# HRMS
...
def run_post_install_patches():
	...
	dontmanage.flags.in_patch = True

	try:
		for patch in POST_INSTALL_PATCHES:
			# patch has not run on the site before
			if not dontmanage.db.exists("Patch Log", {"patch": ("like", f"%{patch}%")}):
				patch_name = patch.split(".")[-1]
				dontmanage.get_attr(f"hrms.patches.post_install.{patch_name}.execute")()
	finally:
		dontmanage.flags.in_patch = False
