...
class TestIncomeTaxComputation(unittest.TestCase):
	...
	def cleanup_records(self):
		dontmanage.db.sql("delete from `tabEmployee Tax Exemption Declaration`")
		dontmanage.db.sql("delete from `tabPayroll Period`")
		dontmanage.db.sql("delete from `tabIncome Tax Slab`")
		dontmanage.db.sql("delete from `tabSalary Component`")
		dontmanage.db.sql("delete from `tabEmployee Benefit Application`")
		dontmanage.db.sql("delete from `tabEmployee Benefit Claim`")
		dontmanage.db.sql("delete from `tabEmployee` where company='_Test Company'")
		dontmanage.db.sql("delete from `tabSalary Slip`")
