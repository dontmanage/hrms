...
import dontmanage
from dontmanage import _, get_all
...
def execute(filters=None):
	...
	if dontmanage.db.has_column("Employee", "ifsc_code"):
		columns.append(
	...
	for salary in salary_slips:
		if (
			...
			row = {
				...
				"payment_date": dontmanage.utils.formatdate(salary.modified.strftime("%Y-%m-%d")),
				...
				"currency": dontmanage.get_cached_value("Company", filters.company, "default_currency"),
