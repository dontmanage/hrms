...
def prepare_data(entry, component_type_dict):
	...
	employee_account_dict = dontmanage._dict(
		dontmanage.db.sql(""" select name, provident_fund_account from `tabEmployee`""")
	)
...
def get_data(filters):
	...
	salary_slips = dontmanage.db.sql(
	...
	component_type_dict = dontmanage._dict(
		dontmanage.db.sql(
...
def get_years():
	year_list = dontmanage.db.sql_list(
