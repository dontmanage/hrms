...
def get_columns(filters):
	...
	if dontmanageerp.get_region() == "India":
		columns.append(
...
def get_data(filters):
	...
	if dontmanageerp.get_region() == "India":
		employee_pan_dict = dontmanage._dict(
			dontmanage.db.sql(""" select employee, pan_number from `tabEmployee`""")
		)

	component_types = dontmanage.db.sql(
