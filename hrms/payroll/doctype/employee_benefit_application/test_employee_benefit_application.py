...
from dontmanage.utils import add_days, date_diff, get_year_ending, get_year_start, getdate
...
class TestEmployeeBenefitApplication(DontManageTestCase):
	def setUp(self):
		date = getdate()
...
def make_employee_benefit_application(employee, payroll_period, date):
	dontmanage.db.delete("Employee Benefit Application")
