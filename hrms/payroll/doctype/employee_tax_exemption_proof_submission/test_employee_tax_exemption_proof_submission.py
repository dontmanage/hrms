...
class TestEmployeeTaxExemptionProofSubmission(DontManageTestCase):
	def setUp(self):
		make_employee("employee@proofsubmission.com", company="_Test Company")
		create_payroll_period(company="_Test Company")
		create_exemption_category()
		dontmanage.db.delete("Employee Tax Exemption Proof Submission")
		dontmanage.db.delete("Salary Structure Assignment")

	def test_exemption_amount_lesser_than_category_max(self):
		proof = dontmanage.get_doc(
			{
				"doctype": "Employee Tax Exemption Proof Submission",
				"employee": dontmanage.get_value("Employee", {"user_id": "employee@proofsubmission.com"}, "name"),
		...
		self.assertRaises(dontmanage.ValidationError, proof.save)
		proof = dontmanage.get_doc(
			{
				"doctype": "Employee Tax Exemption Proof Submission",
				"payroll_period": "Test Payroll Period",
